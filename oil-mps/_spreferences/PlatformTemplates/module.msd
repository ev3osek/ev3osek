...
<solution name="OSEK Implementation Language.__spreferences.PlatformTemplates" uuid="~_PreferencesModule#OSEK Implementation Language.__spreferences.PlatformTemplates" moduleVersion="0" compileInMPS="true">
  <models>
