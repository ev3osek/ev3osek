...
//*****************************************************************************
int
uvsnprintf(char *pcBuf, unsigned int ulSize, const char *pcString,
           va_list vaArgP)
{
    unsigned int ulIdx, ulValue, ulCount, ulBase, ulNeg;
    char *pcStr, cFill;
    int iConvertCount = 0;
...
//*****************************************************************************
int
usnprintf(char *pcBuf, unsigned int ulSize, const char *pcString, ...)
{
    int iRet;
    va_list vaArgP;
...
//*****************************************************************************
void
ulocaltime(unsigned int ulTime, tTime *psTime)
{
    unsigned int ulTemp, ulMonths;
...
{
    unsigned int ulRet, ulDigit, ulNeg, ulValid;
    const char *pcPtr;
